            ...
            <div class="mrb-search-container">
                <div class="mrb-search-box">
                    <div class="mrb-search-field mrb-search-what">
                        ...
                        <input type="text" id="mrb-service-search" placeholder="Salón, DJ, Fotografía..." autocomplete="off" oninput="searchSuggestions(this.value)">
                    ...
                    <div class="mrb-search-field mrb-search-where">
                        ...
                        <select id="mrb-location-search">
                            ...
                            <?php
                            // Obtener TODAS las ubicaciones con jerarquía correcta
                            ...
                            foreach ($all_locations as $location) {
                                if ($location->parent == 0) {
                                    $location_tree[$location->term_id] = array(
                                        'term' => $location,
                                        'children' => array()
                                    );
                                }
                            ...
                            foreach ($all_locations as $location) {
                                if ($location->parent != 0 && isset($location_tree[$location->parent])) {
                                    $location_tree[$location->parent]['children'][] = $location;
                                }
                            }
                            
                            // Mostrar con optgroups
                            foreach ($location_tree as $parent_data) :
                    ...
                    <div class="mrb-search-field mrb-search-when">
                        <label>¿Cuándo?</label>
                        <input type="text" id="mrb-date-search" placeholder="Selecciona fecha" readonly onclick="openDatePicker(this)">
                        <div class="mrb-date-picker" id="date-picker-popup"></div>
                    </div>
...
// Date Picker estilo Airbnb
function openDatePicker(input) {
    const picker = document.getElementById('date-picker-popup');
    if (picker) {
        picker.classList.toggle('active');
        // Aquí iría la lógica del calendario personalizado
    }
}
</script>
